...
int main () {
    ...
    InitWindow(800,800,"Space Galaxy");
    SetTargetFPS(60);
    Image spaceGalaxyBackground = LoadImage("spaceGalaxyBackgound.png");
    ...
    while (!WindowShouldClose())
    {
     ...
     if(!togglePause){
        DrawText(TextFormat("%i",scoreLeft),140,300,260,(Color){ 241, 231, 254, 150 });
        DrawText(TextFormat("%i",scoreRight),540,300,260,(Color){ 241, 231, 254, 150 });
