...
int main () {
    ...
    InitWindow(800,800,"Futuristic");
    SetTargetFPS(60);
    Image spaceGalaxyBackground = LoadImage("futuristic.png");
    ...
    while (!WindowShouldClose())
    {
      ...
      if (!togglePause)
      {
        DrawText(TextFormat("%i",scoreLeft),115,295,120,(Color){ 150, 252, 255, 255 });
        DrawText(TextFormat("%i",scoreRight),638,305,105,(Color){ 150, 252, 255, 255 });
        DrawLineEx({400,0},{400,800},5.0f,(Color){ 150, 252, 255, 255 });
      }
